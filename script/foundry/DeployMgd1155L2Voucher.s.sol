...
contract DeployMgd1155L2Voucher is Script {
  /// Initialize params
  ...
  address private constant NFT1155_L1 = 0x05c67C9f6F6E5370FfC5A787747F5280E560bAE4;
   ...
   * --slow --verify --etherscan-api-key $<etherscan_key> --broadcast script/foundry/DeployMgd1155L2Voucher.s.sol
   */
  function run() public {
    ...
    implementation = address(new Mgd1155L2Voucher());
    console.log("Deployed implementation {Mgd1155L2Voucher}:", implementation);
    ...
    console.log("TransparentUpgradeableProxy for {Mgd1155L2Voucher} deployed:", proxy);
