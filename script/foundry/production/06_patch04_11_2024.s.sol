 ...
 */
contract Patch0411202406 is FileSystem, MgdScriptConstants {
  FileSystem fs;
  ...
  ContractActionConfiguration config = ContractActionConfiguration({
    ...
    mgdVoucher721: Action.UPGRADE,
    mgdVoucher1155: Action.UPGRADE,
  ...
  function executeDeployActions(bool marketPlaceWithVouchers) internal {
    ...
    if (config.escrow == Action.DEPLOY) {
      ...
      MgdL2NFTEscrowDeployer.deployMgdL2NFTEscrow(fs, params, true);
    }
